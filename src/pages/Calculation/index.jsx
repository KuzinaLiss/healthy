...
const addProductToDatabase = async () => {
  try {
    ...
    // После успешного добавления продукта можно выполнить дополнительные действия, если необходимо
...
const saveJournalEntryToDatabase = async () => {
  try {
    ...
    setTodayProducts([...todayProducts, addedJournal]);
  ...
  const handleAddProduct = () => {
    ...
    if (selectedProduct && selectedWeight !== "") {
      ...
      setTodayProducts([...todayProducts, {
        ...
        calories: selectedProduct.calories * selectedWeight / 100, // рассчитаем калории
        protein: selectedProduct.protein * selectedWeight / 100, // рассчитаем белки
        fat: selectedProduct.fat * selectedWeight / 100, // рассчитаем жиры
        carbohydrates: selectedProduct.carbohydrates * selectedWeight / 100, // рассчитаем углеводы
      }]);
